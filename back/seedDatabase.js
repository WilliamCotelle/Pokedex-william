...
const seedDatabase = async () => {
  try {
    ...
    // Réinitialiser la séquence pour la table "Pokemons"
    await sequelize.query(`SELECT setval(pg_get_serial_sequence('"Pokemons"', 'id'), coalesce(max("id"), 1)) FROM "Pokemons";`);

    // Insertion des relations pokemon_type
    const pokemonTypes = [
